							...
							)
							{
								...
								if (this.IsRichTextEnabled)
								{
									...
									textCache = s_QuadTagRegex.Replace(
										textCache, match => GetPostprocessedQuadTag(match, cascadedQuadStyles.List)
									);
											...
											textCache = s_TagRegexes[tag].Replace(
												...
												delegate(Match match)
												{
													...
													)
													{
														...
														foreach (
															IndexRange range in processedIndexRangesAndScalars.Dict.Keys
														)
														{
													...
													m_CustomTags.Add(
														new CustomTag(characterIndices, customTags.Dict[style.Tag])
													);
